...
public class Othernick implements CommandExecutor, TabCompleter {
	@Override
	public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
		...
		target.setDisplayName(Utilities.translate(args[1], false));
		target.sendMessage(Strings.PREFIX + ChatColor.GOLD + target.getName() + ChatColor.GRAY + "'s nickname has been set to " + Utilities.translate(args[1], false) + "!");
